...
<<<<<<< HEAD
							...
							for($i=0;$i<count($result2);$i++){ //liste de utilisateur pour créé la table et les popup
								//var_dump($result);
                ...
                $result=$result[0];
								...
								echo '<tr><th>'.$result2[$i]['username'].'</th><th>'.$result2[$i]['nom'].'</th><th>'.$result2[$i]['prenom'].'</th><th><h4><a href="#" data-width="500" data-rel="popup'.$result2[$i]['id'].'" class="poplight" style="color:black"> <button >fiche de '.$result2[$i]['prenom'].'</button></a>'; if(!isset($result[0]['contrat'])) echo '  <span class="label label-danger">Utilisateur desactivÃ©</span></h4>';
=======
							$result2=$bdd->tab('select a.begin as begin, a.id as id, a.username as username, a.nom as nom, a.prenom as prenom, a.acl as acl, a.mail as mail , a.state as state  from users a','');
							echo '<table style="width:100%;margin-top:40px;"><tr><th>login</th><th>nom</th><th>prenom</th><th>fiche utilisateur<s/th><tr>'; //header du tableau
							for($i=0;$i<count($result2);$i++){
								...
								echo '<tr><th>'.$result2[$i]['username'].'</th><th>'.$result2[$i]['nom'].'</th><th>'.$result2[$i]['prenom'].'</th><th><h4><a href="#" data-width="500" data-rel="popup'.$result2[$i]['id'].'" class="poplight" style="color:black"> <button >fiche de '.$result2[$i]['prenom'].'</button></a>'; if(!isset($result[$i]['contrat'])) echo '  <span class="label label-danger">Utilisateur desactivÃ©</span></h4>';
>>>>>>> origin/master
								echo '</th></tr>';
