...
if (check_admin()) {
    ...
    function add_user($nom, $prenom, $password, $acl, $mail, $contrat, $begin) {
        ...
        if (!check_exist($username)) {
            ...
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> utilisateur ajoutÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=user">';
        } else {
            echo '<div style="border:solid 2px red; background:pink;color:red;padding:1em;display:inline-block" class="droid">erreur : utilisateur dÃ©ja existant</div>';
        }
    }
    ...
    function delete_user($id) {
        ...
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> utilisateur supprimÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=user">';
    }
    function update_user($nom, $prenom, $password, $acl, $mail, $contrat, $id, $begin) {
        ...
        if (!empty($contrat) and !empty($acl) and !empty($begin) and !empty($id)) {
            ...
            $bdd = new bdd();
            $bdd->tab($req, $array);
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> utilisateur mis Ã  jour avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=user">';
        } else {
    ...
    function add_cat($cat, $catdom, $intern = 0) {
        ...
        if ($intern == 0) {
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> catÃ©gorie ajoutÃ©e avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=categorie">';
        } else {
            return $bdd->lastid();
        }
    }
    ...
    function delete_cat($id) {
        ...
        if ($result[0][0]['id_domaine'] != 7) {
            ...
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> catÃ©gorie supprimÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=categorie">';
        } else {
            echo '<div style="border:solid 2px red; background:pink;color:red;padding:1em;display:inline-block" class="droid">CatÃ©gorie nessessaire au fonctionnement de l\'application</div>';
        }
    }
    //gestion des domaine
    function add_dom($dom) {
        ...
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> domaine ajoutÃ©e avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=domaine">';
    }
    ...
    function delete_dom($id) {
        ...
        if ($id != 7) {
            ...
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> domaine supprimÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=domaine">';
        } else {
    ...
    function delcontrat($id) {
        ...
        if (empty($user)) {
            ...
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> contrat supprimÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=contrat">';
        } else {
    ...
    function updatecontrat($array) {
        ...
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> contrat mis Ã  jour avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=contrat">';
    }
    function addcontrat($array) {
        $bdd = new bdd();
        $bdd->tab("INSERT INTO `contrat`( `nom`, `pourcent`, `conge`) VALUES ( ?, ?, ?)", $array);
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> contrat ajouter avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=contrat">';
    }
    function modifmotif($nom, $type, $id) {
        $bdd = new bdd();
        $array = array($nom, $type, $id);
        $bdd->tab('update motif set nom = ?, type=? where id=?', $array);
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> motif mis Ã  jour avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=motif">';
    }
    function delmotif($id) {
        ...
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> motif supprimÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=motif">';
    }
    function addmotif($nom, $type) {
        ...
        echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> motif ajoutÃ© avec succÃ¨s</div><meta http-equiv="refresh" content="2; URL=admin.php?action=motif">';
    }
    function credit_conge() {
        ...
        for ($i = 0;$i < count($user);$i++) {
            ...
            $test = $test[0];
            if (isset($test[0])) {
                if ($nbs <= 363) { //si moins d\'un ans d'ancienetÃ© calcul au prorata
                    $hj = $user[$i]['conge'] / 365;
                    $conge = ceil($nbs * $hj);
    ...
    function admconge($id, $state) {
        ...
        $compteur = $begins;
        $nbjt = 0;
        if ($type[0]['type'] == 2) { // dans le cas d'un deplacement on recrÃ©dite les heures sur le compte
            for ($i = 0;$i < $nbj + 1;$i++) {
                if (isHoliday($compteur) != 1) { //check si c'est un jour de congÃ©
                    if ($begins == $ends) { //si la personne a pris une demie journÃ©
                        ...
                        if ($begins == $compteur or $ends == $compteur) { //si on arrive au debut ou la fin de la periode demandÃ©e
                            if ($begins == $compteur) {
                                if ($begin[1] == '08:30:00') {
        ...
        if ($type[0]['type'] == 1) { // dans le cas d'un conge paye
            for ($i = 0;$i < $nbj + 1;$i++) {
                ...
                if ($type[0]['state'] == 1) { //si il a dÃ©ja Ã©tÃ© valider on recredite le solde de congÃ© de l'utilisateur
                    $nbjt = ($nbjt / 3600) / 7;
            ...
            } //fin du type congÃ© paye
            echo '<div style="border:solid 2px green;background:lightgreen;color:green;padding:1em;display:inline-block" class="droid"> conge mis Ã  jour avec succÃ¨s</div>';
        } //fin fonction
