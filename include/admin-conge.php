...
$bdd = new bdd();
$bdd->cache("SELECT a.id as id, a.begin as begin, a.end as end, c.nom as nom,c.prenom as prenom, b.nom as type , username as user FROM conge a, motif b , users c where a.id_motif=b.id and  a.id_user=c.id and  a.state=0", '');
$result = $bdd->exec();
