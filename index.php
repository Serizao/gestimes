...
<div class="col-md-4">
    ...
    <div class="row"><br>
        ...
        ?>
        <div id="transfretour">
            <div class="col-md-6"><input type="date" class="form-control" id="changetimeuser"></div>
        </div>
    </div>
    ...
    <form id="addconge" method="POST">
        ...
        <div class="row">
            <div class=" col-md-6" style="float:left;">
                ...
                <div style="text-align: left;"><input type="radio" name="bh" value="matin" checked><label> matin</label>
                </div>
                <div style="text-align: left;"><input type="radio" name="bh" value="amidi"><label> après-midi</label>
                </div>
                <div style="text-align: left;"><input type="radio" name="bh" value="day"><label> la journée</label>
                </div>
            </div>
            <div class="col-md-6 ">
                <h5>AU</h5>
                <input type="date" class="form-control" id="endholliday"/><br>
                <div style="text-align: right;"><label>matin</label> <input type="radio" name="eh" value="matin"
                                                                            checked></div>
                <div style="text-align: right;"><label>après-midi</label> <input type="radio" name="eh" value="amidi">
                </div>
                <div style="text-align: right;"><label>la journée</label> <input type="radio" name="eh" value="day">
                </div>
            </div>
        </div>
