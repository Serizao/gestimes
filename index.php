...
<?php
    ...
    echo $datenow;
    $bdd->cache("SELECT a.id as id, a.begin as begin, a.end as end, b.nom as nom, a.state as statut FROM conge a, motif b  where a.id_motif=b.id and id_user=? and DATE_FORMAT(a.begin, '%Y-%m-%d')>='" . $datenow . "' ORDER BY a.begin ASC limit 0, 10", array(
        $_SESSION['userid']
    ));
    $vac = $bdd->exec();
