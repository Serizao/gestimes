...
//couleur
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A4:'.$alphabet[$number].'4')->applyFromArray(
        array(
            'fill' => array(
                'type' => PHPExcel_Style_Fill::FILL_SOLID,
                'color' => array('rgb' => 'FF9900')
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A5:'.$alphabet[$number].'5')->applyFromArray(
        array(
            'fill' => array(
                'type' => PHPExcel_Style_Fill::FILL_SOLID,
                'color' => array('rgb' => 'FF9900')
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A16:'.$alphabet[$number].'16')->applyFromArray(
        array(
            'fill' => array(
                'type' => PHPExcel_Style_Fill::FILL_SOLID,
                'color' => array('rgb' => 'FF9900')
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A20:'.$alphabet[$number].'20')->applyFromArray(
        array(
            'fill' => array(
                'type' => PHPExcel_Style_Fill::FILL_SOLID,
                'color' => array('rgb' => 'FF9900')
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A28:'.$alphabet[$number].'28')->applyFromArray(
        array(
            'fill' => array(
                'type' => PHPExcel_Style_Fill::FILL_SOLID,
                'color' => array('rgb' => 'FF9900')
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A34:'.$alphabet[$number].'34')->applyFromArray(
        array(
            'fill' => array(
                'type' => PHPExcel_Style_Fill::FILL_SOLID,
                'color' => array('rgb' => 'FF9900')
...
//ajout formule
    $objPHPExcel->getActiveSheet()->setCellValue($alphabet[$i].'4', '=SUM('.$alphabet[$i].'2:'.$alphabet[$i].'3)');
    $objPHPExcel->getActiveSheet()->setCellValue($alphabet[$i].'16', '=SUM('.$alphabet[$i].'6:'.$alphabet[$i].'15)');
    $objPHPExcel->getActiveSheet()->setCellValue($alphabet[$i].'20', '=SUM('.$alphabet[$i].'17:'.$alphabet[$i].'19)');
    $objPHPExcel->getActiveSheet()->setCellValue($alphabet[$i].'28', '=SUM('.$alphabet[$i].'21:'.$alphabet[$i].'27)');
    $objPHPExcel->getActiveSheet()->setCellValue($alphabet[$i].'34', '=SUM('.$alphabet[$i].'29:'.$alphabet[$i].'33)');
    $objPHPExcel->getActiveSheet()->setCellValue($alphabet[$i].'36', '='.$alphabet[$i].'4+'.$alphabet[$i].'5+'.$alphabet[$i].'16+'.$alphabet[$i].'20+'.$alphabet[$i].'28+'.$alphabet[$i].'34');
}
